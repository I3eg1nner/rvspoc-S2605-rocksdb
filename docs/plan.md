...
- [x] 最终 db_bench vs 基线（终版 V2，用户裁定含 zicond 交付）：
      read t1 **+31.6%** / read t8 +26.1% / seek +21.1~24.3% /
      fill +4.0%；P99 −18.6%。QEMU 安全变体 V2Z（read t1 +29.5%）
      留档；Makefile 自适应 march（原生逐项探测，交叉落安全集）；
      QEMU 问题在 PR 正文专节说明。数字唯一源 = ACCEPTANCE 二节 +
      benchmark.csv
